...
connect_debug_port u_ila_0/probe1 [get_nets [list {Aurora.aurora_comms/axis_rx[tdata][31]} {Aurora.aurora_comms/axis_rx[tdata][30]} {Aurora.aurora_comms/axis_rx[tdata][29]} {Aurora.aurora_comms/axis_rx[tdata][28]} {Aurora.aurora_comms/axis_rx[tdata][27]} {Aurora.aurora_comms/axis_rx[tdata][26]} {Aurora.aurora_comms/axis_rx[tdata][25]} {Aurora.aurora_comms/axis_rx[tdata][24]} {Aurora.aurora_comms/axis_rx[tdata][23]} {Aurora.aurora_comms/axis_rx[tdata][22]} {Aurora.aurora_comms/axis_rx[tdata][21]} {Aurora.aurora_comms/axis_rx[tdata][20]} {Aurora.aurora_comms/axis_rx[tdata][19]} {Aurora.aurora_comms/axis_rx[tdata][18]} {Aurora.aurora_comms/axis_rx[tdata][17]} {Aurora.aurora_comms/axis_rx[tdata][16]} {Aurora.aurora_comms/axis_rx[tdata][15]} {Aurora.aurora_comms/axis_rx[tdata][14]} {Aurora.aurora_comms/axis_rx[tdata][13]} {Aurora.aurora_comms/axis_rx[tdata][12]} {Aurora.aurora_comms/axis_rx[tdata][11]} {Aurora.aurora_comms/axis_rx[tdata][10]} {Aurora.aurora_comms/axis_rx[tdata][9]} {Aurora.aurora_comms/axis_rx[tdata][8]} {Aurora.aurora_comms/axis_rx[tdata][7]} {Aurora.aurora_comms/axis_rx[tdata][6]} {Aurora.aurora_comms/axis_rx[tdata][5]} {Aurora.aurora_comms/axis_rx[tdata][4]} {Aurora.aurora_comms/axis_rx[tdata][3]} {Aurora.aurora_comms/axis_rx[tdata][2]} {Aurora.aurora_comms/axis_rx[tdata][1]} {Aurora.aurora_comms/axis_rx[tdata][0]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
set_property port_width 4 [get_debug_ports u_ila_0/probe2]
connect_debug_port u_ila_0/probe2 [get_nets [list {Aurora.aurora_comms/axis_rx[tkeep][3]} {Aurora.aurora_comms/axis_rx[tkeep][2]} {Aurora.aurora_comms/axis_rx[tkeep][1]} {Aurora.aurora_comms/axis_rx[tkeep][0]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
set_property port_width 4 [get_debug_ports u_ila_0/probe3]
connect_debug_port u_ila_0/probe3 [get_nets [list {Aurora.aurora_comms/axis_tx[tkeep][3]} {Aurora.aurora_comms/axis_tx[tkeep][2]} {Aurora.aurora_comms/axis_tx[tkeep][1]} {Aurora.aurora_comms/axis_tx[tkeep][0]}]]
create_debug_port u_ila_0 probe
...
connect_debug_port u_ila_1/probe1 [get_nets [list Aurora.aurora_comms/combined_reset]]
...
connect_debug_port u_ila_2/clk [get_nets [list PSxB.ZynqxI/PlatformxB.ScalpZynqPSxI/sys_clock/inst/clkfbout_buf_scalp_zynqps_sys_clock_0]]
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_2/probe0]
set_property port_width 1 [get_debug_ports u_ila_2/probe0]
connect_debug_port u_ila_2/probe0 [get_nets [list {Aurora.aurora_comms/aurora_reset[usr_reset]}]]
set_property C_CLK_INPUT_FREQ_HZ 300000000 [get_debug_cores dbg_hub]
set_property C_ENABLE_CLK_DIVIDER false [get_debug_cores dbg_hub]
set_property C_USER_SCAN_CHAIN 1 [get_debug_cores dbg_hub]
connect_debug_port dbg_hub/clk [get_nets Clk125PllLockedxS]
