...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/andre/dev/mse/ma-lpsc/lpsc/scal_recv_slave/hw_firmware/designs/vivado/scalp_user_design/2023.2/lin64/scalp_user_design/scalp_user_design.cache/compile_simlib/modelsim"
  fi
