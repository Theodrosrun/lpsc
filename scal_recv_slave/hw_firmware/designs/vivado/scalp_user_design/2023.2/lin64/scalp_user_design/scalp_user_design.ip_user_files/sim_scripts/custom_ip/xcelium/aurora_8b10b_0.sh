...
#
# Script generated by Vivado on Tue Apr 28 17:43:53 CEST 2026
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.aurora_8b10b_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.aurora_8b10b_0 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/andre/dev/mse/ma-lpsc/lpsc/scal_recv_slave/hw_firmware/designs/vivado/scalp_user_design/2023.2/lin64/scalp_user_design/scalp_user_design.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log aurora_8b10b_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
