...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot aurora_8b10b_0 xil_defaultlib.aurora_8b10b_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim aurora_8b10b_0 -key {Behavioral:sim_1:Functional:aurora_8b10b_0} -tclbatch cmd.tcl -protoinst "protoinst_files/vga_hdmi_clk_rst_system.protoinst" -protoinst "protoinst_files/bd_c0d9.protoinst" -protoinst "protoinst_files/scalp_zynqps.protoinst" -protoinst "protoinst_files/vga_hdmi_clk_rst_system_inst_2.protoinst" -log simulate.log
}
