...
architecture combinatorial of mandelbrot_iter is
    ...
    -- Q3.15 slice: bits [FRAC_W + DATA_W - 1 : FRAC_W] = [32:15]
    constant SL_HI : integer := FRAC_W + DATA_W - 1;   -- 32
    constant SL_LO : integer := FRAC_W;                -- 15

    signal re2_sl   : signed(DATA_W-1 downto 0);   -- Z_re^2 Q3.15
    signal im2_sl   : signed(DATA_W-1 downto 0);   -- Z_im^2 Q3.15
    signal reim_sl  : signed(DATA_W-1 downto 0);   -- Z_re*Z_im Q3.15
    ...
    signal reim2    : signed(DATA_W downto 0);      -- 2*Z_re*Z_im as Q3.15
...
begin
    ...
    -- =========================================================================
    -- Q3.15 slices  (valid for |val| < 2.0)
    -- =========================================================================
    ...
    --   reim_sl is Q3.15 (18-bit); shift left 1 → Q3.16 (19-bit) = ×2
    -- =========================================================================
