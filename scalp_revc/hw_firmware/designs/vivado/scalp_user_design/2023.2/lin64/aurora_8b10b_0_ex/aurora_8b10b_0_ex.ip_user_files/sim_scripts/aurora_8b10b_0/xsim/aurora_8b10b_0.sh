...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot aurora_8b10b_0 xil_defaultlib.aurora_8b10b_0 xil_defaultlib.glbl -log elaborate.log
}
